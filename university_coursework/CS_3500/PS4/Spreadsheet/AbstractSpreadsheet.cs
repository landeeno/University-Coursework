...

{
...

    {
        ...
        {
            // Adds the cell name to the list of visited cells
            visited.Add(name);

            foreach (String n in GetDirectDependents(name))

            {
                // If a circular dependency exists, throw 
                if (n.Equals(start))
                ...
                // If the next cell has not been visited, iterate through the list
            ...
            // Adds the name of the changed cell to the first of the list for fast efficiency
